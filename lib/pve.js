import { toU8, toHex, clone } from './util.js'
 ...
 * @return {HLHero}
 */
export function upgradePlayer (pk, state) {
 ...
 */
export function computeProgress (xp, career) {
